...
import mega_programmisty.blender.filer.imagereader.ImageReader;
import mega_programmisty.blender.filer.objwriter.ObjWriter;
import mega_programmisty.blender.graphics.model.Model;
import mega_programmisty.blender.graphics.model.utils.NormalsCalculator;
import mega_programmisty.blender.graphics.model.utils.Triangulator;
...
public class ModelMenu extends ObjectMenu {
    ...
    @Override
    public void load() {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/mega_programmisty/blender/model-menu.fxml"));
