...
import mega_programmisty.blender.graphics.engine.shaders.PhongShader;
import mega_programmisty.blender.graphics.engine.shaders.Shader;
...
import mega_programmisty.blender.scene.Scene;

import java.util.ArrayList;
import java.util.List;

import static mega_programmisty.blender.graphics.engine.TriangleRasterization.fillTriangle;
